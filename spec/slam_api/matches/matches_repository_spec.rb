require "slam_api/matches/matches_repository"

RSpec.describe SlamAPI::Matches::MatchesRepository do
  ...
  context ".all" do
    it "retrieves all the matches" do
      ...
      SlamAPI::Matches::MatchesRepository.save(match)

      expect(SlamAPI::Matches::MatchesRepository.all).to include(match)
    end
  end
  ...
  it "assigns a uuid to a match" do
    ...
    expect(SlamAPI::Matches::MatchesRepository.all[0].id).to_not be_nil
  end
  ...
  context ".find_by_id" do
    it "finds the match by its id" do
      ...
      expect(SlamAPI::Matches::MatchesRepository.find_by_id(match.id)).to eq(match)
    end
  end
